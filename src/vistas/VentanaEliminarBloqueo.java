/*
 * Created by JFormDesigner on Fri May 09 11:14:09 CEST 2025
 */
 ...
 * @author elman
 */
public class VentanaEliminarBloqueo extends JFrame {
	public VentanaEliminarBloqueo() {
		try {
	...
	private void desblo1MouseClicked(MouseEvent e) {
		...
		if(desblo.equals("")) {
			...
			this.dispose();
			JOptionPane.showMessageDialog(null, "Contacto desbloqueado correctamente", "Confirmación", JOptionPane.INFORMATION_MESSAGE);
		}
	}
	...
	private void initComponents() {
		...
		//---- label1 ----
		label1.setText("Intrdoduce id a desbloquear");
		contentPane.add(label1, "cell 7 1");
		contentPane.add(desbloTxt, "cell 7 2");
